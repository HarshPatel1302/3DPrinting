    ...
    >
      <div className="mx-auto max-w-7xl">
        <SectionHeader
          ...
          subtitle="Real timelapses from our own Bambu Lab P1S Combo and Creality Ender-3 S1 Pro — muted and looping. More clips in the grid below."
          className="max-w-3xl"
        />
        ...
        <div className="mt-12 flex flex-col items-center gap-3">
          ...
          <p className="max-w-lg text-center text-[11px] leading-relaxed text-muted-foreground">
            Filmed in our workshop. Trademarks belong to their owners.
          </p>
        </div>
      </div>
    </section>
